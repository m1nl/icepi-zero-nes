...
_io_common = [
    ...
    (
        "sdram",
        0,
        Subsignal("a", Pins("B10 A9  B9  A8  B8  A7  B7  A6 ", "B6  A5  A10 B5  A4 ")),
        Subsignal("dq", Pins("B16 C14 C16 C15 D16 A15 B15 A14", "A2  B2  E2  D1  C2  C1  C3  B1 ")),
    ...
    (
        "gpio",
        0,
        Pins("G3 K3 R1 E1 F3 G1 H2 J1 L2 G2 J3 E3 P1 N1 H3 R3 N4 E4 F1 F2 P2 M2 L1 J2 D4 P3"),
        IOStandard("LVCMOS33"),
    ),
    # I2C - GPIO2, GPIO3
    (
